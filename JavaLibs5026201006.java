...
public class JavaLibs5026201006 {
    ...
    String nama = JOptionPane.showInputDialog ("Nama Pemesan");
    ...
    "\nTiket akan dikirimkan melalui" + " " + email + "." + " " + "Apabila terjadi perubahan jadwal, selanjutnya akan diinformasikan melalui Email tertera dan pesan ke nomor" + " " + telpon + "."); 
